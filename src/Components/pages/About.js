...
const About = (p) => (
  <>
    ...
    <main>
        <p>
            <span>Vis blog </span>
             is a website for anyone, who wants a simple and powerful blogging platform. It is also very fast, as it is
        ...
        <p>
            Anyone can login via there google account and use the blogging features of the Vis blog. it provides a simple          interface
            for writing clear and concise blogs. the blogs created by the user can be edited and deleted by the user if he/she
            wants. The list of the blogs created by the user is given on the dashboard. The user can track the views of their           blogs.
        ...
        <p>
            Vis blog front-end is created ,using the react.js and the back-end is written in node.js. For data storage, MongoDB is
